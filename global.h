...
EXTERN int g_insertion_momentum_list[MAX_MOMENTUM_NUMBER][3], g_insertion_momentum_number;
...
EXTERN int g_sink_gamma_id, g_sink_gamma_id_list[16], g_sink_gamma_id_number;
